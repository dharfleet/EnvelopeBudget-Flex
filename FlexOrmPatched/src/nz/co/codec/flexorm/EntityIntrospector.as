package nz.co.codec.flexorm
{
	...
	public class EntityIntrospector
	{
		...
		private function extractManyToOneAssociation(v : Object, entity : Entity, property : String) : void
		{
			 ...
			 *****************************************************/
			var type : Class;
			var manyToOneType : String = StringUtil.trim(metadata.arg.(@key == Tags.ATTR_TYPE).@value.toString());
			if (manyToOneType == "")
			{
				type = getClass(v.@type); // associated object class
			}
			else
			{
				type = getClass(manyToOneType);
			}
			/******************************************************
			 * END OF CHANGE
			 *****************************************************/
